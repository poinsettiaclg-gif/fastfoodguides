...
<div class="callout callout-tip">**ProTip:** The iPOS tablets feature a "Store" and "Hold" function, allowing a team member to start an order, place it on hold to assist another guest or verify an item, and resume it without losing the workflow.</div>
...
<div class="callout callout-tip">**ProTip:** A major focus of efficiency reviews is "closing the gaps" between cars. Operators will literally review "game film" (security or drone footage of peak hours) to spot merge conflicts or loose spacing that reduces queue capacity.</div>
