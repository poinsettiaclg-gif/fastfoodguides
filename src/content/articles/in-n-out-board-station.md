...
description: "The In-N-Out Board station is the hardest job in the building. Learn the setup, wrapping technique, certification test, and what rush hour really feels..."
pubDate: '2025-11-03'
...
On more than one occasion, green crew members underestimate the setup phase. Before the store opens, you need to make sure every single container is fully stocked and positioned correctly. If you run out of shredded lettuce mid-rush and have to walk to the cooler, you've just created a fifteen-second gap that the Grill cook cannot absorb. Those fifteen seconds mean burnt patties.

<div class="callout callout-tip">**ProTip:** Master the "Two-Swipe" Spread. Use the bottom-left corner of the spread insert to get about two inches of spread on your spatula. Place it in the center of the bun and use two swipes (one toward you, one away) to cover it efficiently.</div>
...
<div class="callout callout-tip">**ProTip:** Dress by Layer, Not by Burger. Never complete one burger entirely before moving to the next. Work in layers across the whole row, like spreading all buns, then moving to tomatoes, then lettuce. This prevents you from grabbing the same ingredient multiple times and significantly increases speed.</div>
