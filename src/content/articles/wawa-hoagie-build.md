...
1.  **Bread type** — White Italian roll, wheat roll, or the Shorti (a junior-sized roll, roughly 6 inches). The Classic roll is a full 10-inch sub roll.
2.  **Protein** — You pick your meat or combination. Options range from turkey and roast beef to Italian cold cuts and chicken salad.
3.  **Cheese** — American, provolone, Swiss, pepper jack, or no cheese.
4.  **Toppings** — Lettuce, tomato, onions, pickles, hot peppers, sweet peppers, and more. You can specify amounts on most toppings (regular or extra).
5.  **Sauces and seasonings** — Mayo, mustard, oil and vinegar, hot sauce, oregano, salt, pepper. The oil and vinegar option is a big deal — that's what makes the Italian hoagie taste right.
...
<div class="callout callout-tip">
  <strong>ProTip:</strong> The biggest friction point in modern Wawa delis is the competing order streams. Walk-in customers frequently get frustrated waiting for their hoagies, not realizing the associates are simultaneously battling a massive queue of invisible mobile app and delivery orders hitting the same screen.
</div>
