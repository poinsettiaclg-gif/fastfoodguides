...
description: Chick-fil-A filters their peanut oil multiple times a day. This is the
...
This is how a mid-shift filter works when you are holding on a massive drop of chicken:
...
<div class="callout callout-tip">**ProTip:** The Henny Penny fryers enforce quality via a "Filter Lockout" feature. After 4 to 5 cook cycles, the machine physically prevents another drop and displays "YOU MUST FILTER NOW." If a kitchen doesn't stagger their fryer cycles correctly, multiple lockouts hitting at once can temporarily halt chicken production entirely.</div>

<div class="callout callout-tip">**ProTip:** The automated pump isn't enough on its own. During a filter lockout, the fry cook must use specialized L-shaped and poker brushes to manually scrape carbonized breading from the heating elements and drain opening before returning the clean oil to the vat.</div>
...
1. The empty vat is filled with water and a highly caustic boil-out chemical (in effect industrial degreaser).
