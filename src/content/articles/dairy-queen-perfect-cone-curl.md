...
<div class="callout callout-tip">**ProTip:** Dairy Queen enforces strict weight standards to maintain margins and consistency. A Small cone should weigh 5.0 ounces, a Medium 7.0 ounces, and a Large 10.0 ounces, usually with a strict 0.2-ounce tolerance window.</div>
...
I always told new staff: watch the ice cream, not your hand. New employees tend to stare at their own wrist during the curl, which throws off their timing completely. Focus on the point where the ice cream meets the cone. You'll develop a better feel for when to snap the tail by watching the product itself rather than obsessing over your hand movement.

## The Machine Calibration Factor

Nobody mentions this during onboarding, but: even with perfect technique, your cones will look wrong if the machine is not properly calibrated. The soft serve machine has adjustable settings for temperature and overrun—the amount of air mixed into the product—and both directly affect how the ice cream behaves.
...
<div class="callout callout-tip">**ProTip:** If the soft serve machine is running slightly warm during a rush, experienced employees will occasionally stash a built cone in the blast freezer for 5 to 10 seconds to firm up the exterior before attempting the dip. This hack significantly reduces the chance of the dreaded "cone drop".</div>
