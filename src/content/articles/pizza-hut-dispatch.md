...
![Flat vector diagram of a delivery routing map showing a double order path](../../assets/images/pizza-hut-dispatch/pizza-hut-delivery-routing-algorithm-map.webp)
