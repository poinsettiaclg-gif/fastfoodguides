...
<div class="callout callout-tip">**ProTip:** Crumb trays on filter systems must be emptied into a fireproof container at the end of the night. Leaving batter fragments soaking in oil overnight is a spontaneous combustion hazard.</div>
...
This technique is unique to wet-batter frying operations. You won't see it at a standard chicken chain. Even [The Popeyes Chicken Battering Process: Why It's So Crispy](/articles/popeyes-chicken-battering-process/) uses a dry-wet-dry breading method that allows basket frying, which is a completely different mechanical approach.
...
<div class="callout callout-tip">**ProTip:** The signature "extra crunchies" are created by deliberately drizzling or dropping small amounts of the thin, heavily leavened batter directly into the oil during the cooking cycle.</div>
...
This is a fundamentally different oil management challenge than what you see at [How Dangerous Are the KFC Pressure Fryers?](/articles/kfc-pressure-fryers/), where the sealed pressure environment actually extends oil life significantly compared to an open-vat system.
