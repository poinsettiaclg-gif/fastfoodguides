...
3. **The Boil:** When it's time to make a fresh batch of chili, the frozen meat crumbles are pulled from the freezer and placed into a massive pot of boiling water. This second cooking step ensures the meat is thoroughly re-cooked to a safe temperature.

<div class="callout callout-tip">
  <strong>ProTip:</strong> The boiling step isn't just for food safety; it extracts much of the residual grease from the original grill cooking. The water will look intensely cloudy and greasy—that's how you know you're keeping all that extra fat out of the final chili batch.
</div>
...
Every bag of chopped chili meat in the freezer must have a clear date on it. Old bags get used first—FIFO (First In, First Out).

<div class="callout callout-tip">
  <strong>ProTip:</strong> If you find an undated bag of chili meat shoved to the back of the walk-in, show it to your manager immediately and discard it. Never guess when it was prepped. Using undated product is a severe food safety violation that will instantly fail a health inspection.
</div>

The other common mistake is not stirring from the bottom. Green crew members will give the chili a surface stir and call it done. The beans and thick chili base stick to the bottom of the pot and scorch, creating a burnt flavor that taints the entire batch. A proper bottom-to-top stir with a long ladle, scraping the bottom on every pass, prevents this entirely.
...
Yes. Wendy's makes fresh batches daily. The chili base is mixed with freshly boiled meat crumbles each time a new batch is assembled. Leftover chili from the previous day is not carried over, reheated, or served the next morning. When the [closing duties](/articles/wendys-closing-duties) checklist is complete, any remaining chili is discarded.
