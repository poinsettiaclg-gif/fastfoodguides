...
<div class="callout callout-tip">**ProTip:** If the system stops responding to POS orders, the first troubleshooting step is verifying it hasn't been accidentally bumped into 'Manual' or 'Semi-Automatic' mode on the touchscreen.</div>
