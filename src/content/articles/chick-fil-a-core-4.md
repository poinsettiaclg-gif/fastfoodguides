...
**ProTip:** The true test of the Core 4 happens when operations break down. When wait times spike due to a kitchen bottleneck, employees are trained to switch to the **HEARD model** (Hear, Empathize, Apologize, Resolve, Delight). A Team Member who can maintain Core 4 eye contact and tone while executing HEARD on an angry customer is usually fast-tracked for a Certified Trainer promotion.
</div>
...
<div class="callout callout-tip">
**ProTip:** Training doesn't just happen by word of mouth. Chick-fil-A uses an internal tablet app called **Pathway** to track modules and knowledge checks. Before a Team Member is left alone on a register, a Certified Trainer uses the "Teach, Model, Coach, Correct" framework to ensure the Core 4 is being executed to standard.
</div>
...
Yes. While "My Pleasure" is technically part of the Second Mile Service initiative rather than the Core 4 itself, it is a mandatory response at virtually every Chick-fil-A location. When a guest says "Thank you," you respond with "My Pleasure" instead of "You're welcome" or "No problem." It is one of the most recognizable elements of the entire brand, and green crew members who default to "No problem" will be corrected immediately and repeatedly until the habit sticks.
