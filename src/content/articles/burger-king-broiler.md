...
<div class="callout callout-tip">**ProTip:** Be prepared for "Hot Off the Broiler" (HOB) requests. While you must accommodate them, dropping a single, out-of-sequence patty throws off the rhythm of batch cooking, so communicate clearly with the expeditor about the immediate 3-minute delay for that specific order.</div>
...
<div class="callout callout-tip">**ProTip:** Don't attempt to speed up the feed by placing patties too close together on the belt. This lowers the internal temperature of the broiler chamber, resulting in undercooked beef, and creates a massive bottleneck when they all drop into the catch pan simultaneously. Space them evenly.</div>
