...
faq:
  - question: "Why doesn't Arby's pre-slice their roast beef?"
    answer: "Pre-slicing makes precise portion control (exactly 3.0 ounces per Classic sandwich) nearly impossible at speed, and the freshly sliced meat retains moisture much better than pre-sliced meat sitting in a warmer."
  - question: "What is the PAA bottleneck at Arby's?"
    answer: "PAA stands for Plan vs. Actual, a metric managers use to track labor and productivity. The slicer station is a common bottleneck, so managers monitor PAA to ensure throughput standards like 50-75 second drive-thru times are met."
---
...
If you are assigned to the slicer station, you have already earned serious trust. In most locations, only managers or specifically certified adult employees touch this machine. One memorable shift, first-timers stare at the slicer on their first day like it is a medieval torture device, and honestly, that level of respect is appropriate.
...
<div class="callout callout-tip">**ProTip:** The most common cause of a jammed slicer chute or ragged meat isn't just a dull blade—it's failing to properly clean the sharpening stones, which causes the blade to shred the roast beef instead of producing paper-thin slices.</div>

<div class="callout callout-tip">**ProTip:** Arby's managers constantly monitor 'PAA' (Plan vs. Actual) variance reports. If the slicer operator is too slow, the entire line backs up, wrecking the strict 50-75 second drive-thru target times.</div>
