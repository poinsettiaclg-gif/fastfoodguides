...
<div class="callout callout-tip">**ProTip:** When substituting or adding syrups for a custom drink, explicitly split the pump counts to maintain the total volume ratio. If a Venti normally gets 6 pumps, don't just say "add vanilla and caramel." Specify "3 pumps of vanilla and 3 pumps of caramel" to avoid receiving a cloying 12-pump drink.</div>
