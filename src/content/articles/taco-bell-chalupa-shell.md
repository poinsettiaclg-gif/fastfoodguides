...
A flat disc of dough can't fry itself into a taco shape — it would just puff up into a pillow. Taco Bell uses a **specialized frying mold** (sometimes called a chalupa press or chalupa basket) to force the dough into the right shape while it cooks.
...
<div class="callout callout-tip">**ProTip:** Dropping too many chalupa baskets into the fryer at once will tank the oil temperature below the required 350°F. When the temp drops, the shells absorb more oil rather than frying cleanly, resulting in a soggy, greasy shell instead of the signature crispy-chewy texture.</div>
...
<div class="callout callout-tip">**ProTip:** The official spec requires crew members to let the freshly fried shell drain in the basket for about 30 seconds before passing it to the make line. Skipping this step is the number one cause of a pool of orange grease at the bottom of a customer's chalupa wrapper.</div>
...
- [Your First Day at Taco Bell: Surviving the Make-Line](/articles/taco-bell-first-day-training/)
