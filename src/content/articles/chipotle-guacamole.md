...
3. **Cilantro** (fresh, hand-chopped)
4. **Red onion** (fresh, hand-diced)
...
<div class="callout callout-tip">**ProTip:** A standard case count fluctuates wildly based on the size of the fruit. Employees report cases ranging from 32 to 84 avocados. You always yield by weight and volume, not just the unit count.</div>
...
1. **Fresh lime juice** — squeezed from real limes, not from a bottle. The acid serves double duty: it adds flavor and slows oxidation (browning)
2. **Diced red onion** — cut to a small, uniform dice during a separate prep task earlier in the morning
3. **Chopped cilantro** — fresh bunches, stems removed, roughly chopped
4. **Diced jalapeño** — seeds removed for heat control, cut to a fine dice
5. **Kosher salt** — the only seasoning, added to taste
...
<div class="callout callout-tip">**ProTip:** To combat the labor bottleneck, the 'Autocado' automates cutting, coring, and peeling up to 25 pounds of avocados at once before a human finishes the hand-mashing.</div>
...
- [The Chipotle Grill Cook: Why It's the Hardest Job in Fast Casual](/articles/chipotle-grill-validation/)
