...
<div class="callout callout-tip">**ProTip:** Don't stress about memorizing everything before you start. Every store is required to have laminated physical 'Build Cards' mounted directly above the cold and hot wells. You can simply look up and follow the left-to-right visual diagrams while you build muscle memory.</div>
...
The grill press seals the fold shut with heat, so the fold does not need to be geometrically perfect—it just needs to be tight enough that ingredients do not spill out before it hits the press. New staff waste time trying to create a perfectly symmetrical hexagon. Speed matters more than aesthetics here. As long as all the edges are tucked toward the center and the fold side goes down on the grill, the Crunchwrap will come out looking professional.
...
Almost every LTO is a variation of an existing base. A limited-time loaded burrito is still a burrito base with one or two special ingredients—a new sauce, a different cheese blend, a crunchy topping. When the LTO training card goes up, scan it for the base it most closely resembles and then note only the differences. This turns a seemingly brand-new item into a minor tweak you can learn in five minutes instead of memorizing from scratch.

<div class="callout callout-tip">**ProTip:** If you want to practice at home, many employees create digital flashcards on sites like Brainscape or StudyStack specifically for Taco Bell build orders. Reviewing these decks for 15 minutes a day before your shift will dramatically accelerate your speed on the line.</div>
