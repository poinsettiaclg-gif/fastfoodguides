...
<div class="callout callout-tip">**ProTip:** Never mix parts between different Collectramatic fryers. Even if a lid or locking pin looks identical, micro-warping from heat over time means they are mated to their specific fry pot. Mixing them can compromise the pressure seal.</div>

## The Drop: Where the Real Injuries Happen

Injuries from KFC pressure fryers almost never come from the pressure system. They come from loading the machine.
...
<div class="callout callout-tip">**ProTip:** When cleaning the Collectramatic, cooks must use an OEM-approved spatula to scrape the cookpot's crust line. Using unauthorized metal tools can scratch the interior, creating spots where breading will stick and burn in future batches.</div>
