...
<div class="callout callout-tip">
  **ProTip:** Load balancing only works if the human crew is ready. Stacking up too many proofed dough trays in advance during a rush will cause the dough to over-proof and bubble in the oven, effectively grinding Pulse's optimized makeline flow to a halt because of a manual prep mistake.
</div>
...
See also: [Domino's $20 bank rule](/articles/dominos-20-bank-rule/)
...
<div class="callout callout-tip">
  **ProTip:** One major friction point in Pulse dispatching during massive events is handling complex apartment complexes or newly built subdivisions. If the address mapping in Pulse isn't perfectly updated locally, the algorithm's routing suggestions will fail, forcing shift managers to manually override driver assignments—a huge time sink during the Super Bowl.
</div>
