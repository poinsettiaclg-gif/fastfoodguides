...
1.  **Bread pull:** Grab the correct bread from the bread rack — French bread or wheat, sliced lengthwise. The bread was baked fresh that morning (more on that in a second) and is already cut and staged.
2.  **Sauce and spread:** Mayo, mustard, oil and vinegar, or Jimmy Mustard get applied first. These are kept in squeeze bottles within arm's reach.
3.  **Meat:** Grab the pre-portioned meat — the recipes specify exact weights, and experienced makers learn to eyeball the correct amount within a gram or two.
4.  **Cheese:** Provolone slices, pulled from a pre-fanned stack.
5.  **Vegetables:** Lettuce, tomato, onion, whatever the sandwich calls for. Grabbed from the cold table bins directly above the cutting board.
6.  **Close, wrap, bag:** The sandwich is closed, wrapped tightly in the signature paper (there is a specific wrapping technique that first-timers practice obsessively), and either handed to the customer or bagged for delivery.
...
_For more sandwich shop breakdowns, check out our guides on [how Subway's bread baking process works](/articles/subway-bread-baking-process), [what “Mike's Way” actually means at Jersey Mike's](/articles/jersey-mikes-mikes-way), and [the Jersey Mike's hot sub grill process](/articles/jersey-mikes-hot-sub-grill)._

* * *

**Related Guide:** [The Subway Bread Baking Process: Why It Smells Like That](/articles/subway-bread-baking-process/)
