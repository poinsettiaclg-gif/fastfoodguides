...
<div class="callout callout-tip">**ProTip:** A single bag of ground beef is expected to yield exactly 22 patties of 3.6 ounces. If a prep cook is consistently getting 21 or 23 patties per bag, management knows they aren't calibrating their scale correctly.</div>
...
<div class="callout callout-tip">**ProTip:** Five Guys never adds oil to the grill when cooking the meat. The 80/20 lean-to-fat ratio provides all the natural beef tallow needed to season the flattop and prevent sticking.</div>

## The 80/20 Lean-to-Fat Ratio and Proprietary Blend Science

The physics of the Five Guys smash burger depend entirely on the specific grind and fat percentage of the fresh meat delivered to the restaurant. Five Guys utilizes a proprietary blend of chuck and sirloin calibrated to a strict **80/20 lean-to-fat ratio**:
- **Why Fat Percentage Dictates Texture:** If the beef blend were too lean (such as 90/10), smashing the meatball onto a 400°F flat-top grill would instantly vaporize the minimal moisture, leaving behind a dry, leathery disc of meat. The 20% fat content acts as a thermal buffer and natural basting agent. When smashed, the fat renders out instantly, frying the patty in its own beef tallow and creating those lace-like, crispy outer edges while retaining an internal juicy core.
- **Grind Coarseness & Protein Binding:** The meat is ground to a specific coarseness without over-processing. Over-grinding or over-mixing beef releases myosin, a sticky muscle protein that causes burgers to bind together like sausage or meatloaf. By hand-rolling the meatballs with gentle palm pressure rather than mechanical compression, prep cooks ensure the internal grain structure remains loose and tender, allowing steam to escape uniformly during cooking.

## Cambro Sanitation, Shelf-Life Timers, and HACCP Audits

Because raw, un-frozen beef is highly perishable and subject to rapid microbial growth if temperature controls fail, the morning meat prep station operates under strict Hazard Analysis Critical Control Point (HACCP) protocols:
- **Cambro Layering & Cross-Contamination Defense:** Every cambro tub must be washed, rinsed, and sanitized before receiving fresh meatballs. Each layer of 16 balls is separated by a food-grade silicone parchment square that prevents raw proteins from sticking together or tearing when pulled by the grill cook during a rush. A full cambro holds four layers (64 balls total), weighing approximately 14.4 pounds.
- **The 36-Hour Maximum Shelf Life Rule:** Once a cambro is filled, it is sealed with a snap-on lid and marked with an automated expiration tag. Freshly rolled meatballs have a maximum refrigerated holding shelf life of 36 hours at 33°F to 37°F (0.5°C to 2.8°C). During corporate EcoSure audits, inspectors pull cambros directly from the chef base draw coolers beneath the grill and test the internal temperature of the meatballs using a sanitized needle thermocouple probe. If a single meatball temps above 40°F (4.4°C) or lacks a legible expiration tag, the entire tub must be condemned and destroyed immediately.
