...
**ProTip:** This technique is known internally as "line busting." An experienced iPOS order taker knows exactly how to read a car. If the driver is on the phone or yelling at kids in the backseat, the team member instantly skips them, takes the next two orders, and circles back. This fluidity destroys the static speaker box bottleneck.
</div>
...
<div class="callout callout-tip">
**ProTip:** Tablets are useless without a strong connection. To support 5-10 iPads constantly transmitting data to the kitchen display screens (KDS), Chick-fil-A mounts commercial-grade Wi-Fi extenders directly onto the exterior building walls and underneath the drive-thru canopies. A single Wi-Fi dead zone in the parking lot will cause the entire line to stall.
</div>
