...
## Liquid Syrups vs. Thick Sauces (White Mocha, Pumpkin, and Chai Calibration)
...
As Starbucks expanded its cold beverage menu, new sizing standards created additional exceptions to the baseline progression that every barista must master:
- **The Trenta Progression (30 oz):** The Trenta size is reserved exclusively for iced teas, iced coffees, Refreshers, and Cold Brews. When adding syrup to a Trenta beverage, the pump count increases to **7 full Hot Bar pumps** (or 14 CBS pumps if using cold bar flavors). 
- **Iced Shaken Espressos (Half-Dose Standard):** The Iced Brown Sugar Oatmilk Shaken Espresso and its flavor variations introduced a unique volumetric standard. Because these drinks are aggressively shaken with ice to create a rich, aerated foam, using full-volume pumps makes them oversweet and heavy. Therefore, all Iced Shaken Espressos receive **half-dose pumps** (using a CBS pump or half-pumping a Hot Bar bottle) following a **3-4-6 progression** (Tall, Grande, Venti Iced). If a customer modifies a Shaken Espresso by requesting a different syrup like White Mocha, baristas must apply half-dose pump counts to maintain the intended balance between the espresso roast and the oatmilk foam.
