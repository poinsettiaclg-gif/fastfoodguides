...
The freezer should be reorganized after every delivery. It takes five extra minutes and prevents entire boxes of product from being wasted. This is the same FIFO principle used at operations like [Panera's overnight bake](/articles/panera-overnight-baker) and virtually every professional kitchen in the industry.
...
<div class="callout callout-tip">**ProTip:** If staffing allows, pair up for the pull. Have one partner physically pull and arrange the items on the trays while the other writes and applies the day-dot stickers. This can cut the task time in half.</div>
