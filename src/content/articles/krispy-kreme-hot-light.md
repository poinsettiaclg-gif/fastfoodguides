...
As the doughnut cools, its physical profile changes:
...
<div class="callout callout-tip">**ProTip:** The most reliable way to track the Hot Light without driving by is using the official Krispy Kreme mobile app, which features real-time notifications for when the light switches on at your local store.</div>
