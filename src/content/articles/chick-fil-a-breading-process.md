...
description: Chick-fil-A hand-breads every filet to order. This is how the breading
...
**ProTip:** The breading station (the "coater") has a sifter built in or nearby. As the wet chicken goes into the flour, it creates wet clumps known as "dough balls." If the breader doesn't sift the flour regularly during a rush, these clumps stick to the next batch of chicken, resulting in uneven frying and a terrible texture.
</div>

Trainees consistently make two mistakes here: they either don't press hard enough (resulting in thin, patchy breading that shows bare chicken underneath) or they don't shake off the excess (resulting in raw flour pockets that taste pasty after frying).
...
The hand-breading process is the single biggest bottleneck in Chick-fil-A's kitchen. This is the math:

- A typical busy location might need **200-300 filets** during a lunch rush (11 AM - 2 PM)
- Each filet must be individually hand-breaded (milk wash â†’ flour â†’ press â†’ shake)
...
<div class="callout callout-tip">
**ProTip:** The breader is arguably the most physically demanding job in the store. A high-volume store requires the breader to use their upper body weight to lean into the flour bin and press the chicken. Over a 6-hour shift, this leads to significant fatigue. During peak rushes, the breader works entirely off a KDS screen predicting volume, often "breading ahead" for the next drop just to survive the surge.
</div>
