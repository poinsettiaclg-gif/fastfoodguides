...
<div class="callout callout-tip">**ProTip:** To achieve the signature consistency, pulse the cabbage in the vertical cutter mixer until it's the size of rice. Over-processing turns it to mush, while under-processing leaves it too crunchy.</div>

Nobody mentions this during onboarding, but during training: the chop consistency matters more than you'd think. If the food processor blades are getting dull—and they do, faster than management wants to replace them—you'll get an uneven chop. Some pieces come out as fine confetti, others as big, tough chunks. Those different-sized pieces macerate at completely different rates, so your finished coleslaw has some pieces that are properly soft and others that still crunch like raw salad. Pulling double shifts taught me that trainees not notice until a customer complains. If you're on prep and the chop looks ragged, flag it to your manager immediately. Dull blades need sharpening or replacing before you waste an entire batch.
