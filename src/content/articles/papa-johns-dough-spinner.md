...
2. **Place the ball dead center on the bottom platen.** And I mean dead center. Over the years, new staff eyeball this and produce lopsided crusts that are thick on one side and paper-thin on the other. Some veteran operators actually make a tiny flour mark on the platen as a centering guide.
...
<div class="callout callout-tip">**ProTip:** Ensuring dough is the correct temperature (typically 50–55°F) is critical for consistency when using the spinner.</div>

<div class="callout callout-tip">**ProTip:** Use enough 'dustinator' on the carpets of the spinner and place the dough mound-side down with a slow, steady press to prevent 'tails'.</div>
