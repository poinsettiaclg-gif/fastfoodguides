...
![Five Guys Burger Build How It](../../assets/images/general/generic-walk-in-2.webp)
...
<div class="callout callout-tip">**ProTip:** The assembly and wrapping stage is synchronized flawlessly with the grill. While the cook flips the patties, the assembler prepares the foil and bun. The moment the patty comes off the grill, it is placed on the bun and wrapped immediately to maximize the trapped steam heat.</div>
...
This is the operational reality of "free toppings": **there are no portion controls**. Unlike McDonald's, where every pickle slice and onion portion is specified to the gram, Five Guys gives the assembler discretion to add a "reasonable" amount of each topping.
...
The downside is that the bag gets greasy. Very greasy. Five Guys knows this — it's for all practical purposes a feature at this point.
...
3. **Slower throughput** — A Five Guys kitchen can't match the volume of a McDonald's or Burger King because every burger is functionally made to order
