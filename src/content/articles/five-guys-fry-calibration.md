...
description: "A QSR veteran explains the daily Five Guys fry calibration processu2014 the Mush Test, two-stage cooking, starch washing, and why potatoes change..."
pubDate: '2024-10-06'
...
The entire calibration process takes 20 to 30 minutes on a normal day. If a new shipment of potatoes arrives from a different farm or a different region, it might take a few extra rounds of testing to dial in the right settings. Back when I was running shifts, calibration would take close to 45 minutes when the potatoes were behaving unusually—high-sugar winter potatoes that wanted to brown in 90 seconds were the worst offenders.

<div class="callout callout-tip">**ProTip:** Fry calibration isn't just a morning task—it is performed twice daily. Cooks recalibrate right before the dinner rush because ambient kitchen temperature and potato moisture can shift significantly over the course of a single day.</div>
