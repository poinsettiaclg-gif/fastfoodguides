...
Let me run the numbers I used to show first-timers during orientation, because this is where the job either makes sense or doesn't.
...
<div class="callout callout-tip">**ProTip:** Driving an older, fully depreciated compact car (like a 2005 Corolla) is the ultimate hack for delivery drivers. Since the car has already hit the bottom of its depreciation curve, you aren't losing vehicle value with every mile, meaning you get to keep a much higher percentage of that mileage reimbursement as actual take-home profit.</div>
...
> **Financial/Tax Disclaimer:** This website does not provide financial or tax advice. Under the Tax Cuts and Jobs Act (TCJA), many traditional employee deductions have been eliminated. Always consult a Certified Public Accountant (CPA) or a licensed tax professional regarding your personal tax situation.

I always told my drivers to download a free mileage-tracking app on day one—something that runs in the background and automatically logs every delivery trip. Having a clear picture of your actual vehicle expenses versus your reimbursement is the only way to know if you are actually making a profit.
...
<div class="callout callout-tip">**ProTip:** Turn off your engine while waiting at the store. Many new drivers will leave their cars idling in the parking lot while they run inside to wait on the dispatch screen or grab a completed order. Idling burns gas at zero MPG and actively eats away your reimbursement surplus.</div>
