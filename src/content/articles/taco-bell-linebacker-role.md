...
<div class="callout callout-tip">**ProTip:** The Linebacker is responsible for calling out "drops." If a pan of beef only has a few scoops left, they must verbally communicate to the prep cook in the back to drop a new vacuum-sealed bag into the 195°F rethermalizer before the current supply runs completely dry.</div>

## The Mental Game: Situational Awareness Is Everything

The Linebacker role is often considered the most mentally exhausting position in the restaurant.
...
<div class="callout callout-tip">**ProTip:** Great Linebackers also act as real-time quality control. Because they aren't staring at the KDS monitor, they have the bandwidth to notice if the Stuffer is using the wrong cheese blend or if the Starter is wrapping a burrito too loosely, correcting errors before they hit the drive-thru window.</div>
