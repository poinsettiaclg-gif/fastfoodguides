...
Most rookies stack the bread molds too close together inside the retarder, blocking the airflow vents. Result: uneven thawing. The sticks on the outside thaw perfectly while the ones in the center are still partially frozen. Getting the retarder load right is one of the most important closing responsibilities, and it is the one that gets the least attention in training.
...
- **Scoring:** Using a sharp blade, cut 3 to 4 diagonal slashes about a quarter-inch deep across the top. This lets steam escape during baking so the bread expands cleanly instead of cracking randomly. Trainees almost always make timid, shallow cuts. A shallow score seals back up in the oven and traps steam inside—the bread will crack in unpredictable places and look terrible.
...
*For more Subway behind-the-counter secrets, check out our guides on the [Subway Bain Fill Line Rule](/articles/subway-bain-fill-line-rule), [how to fold a Subway wrap without tearing it](/articles/subway-wrap-folding), and [mastering the Subway POS system](/articles/subway-pos-out-of-order).*
