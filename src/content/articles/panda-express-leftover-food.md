...
**ProTip:** Some Area Coaches mandate that General Managers send a timestamped photo of the waste bin alongside the digital log at closing. This prevents stores from "pencil-whipping" the numbers to hide food cost issues.
</div>
...
<div class="callout callout-tip">
**ProTip:** The most effective closing strategy is switching to "cooking on call" in the last 30 minutes. Instead of keeping pans full, only drop a small batch of a specific protein when a customer actually requests it.
</div>
