...
A standard latte takes a skilled barista approximately **35 to 45 seconds** to craft using automated Mastrena espresso shots and rapid milk steaming. A Venti Honey Citrus Mint Tea requires a labor-intensive **5-step manual assembly routine**:

1.  **Dual Tea Bag Extraction:** The barista must step away from the espresso bar to the dry tea station, locate two separate tea canisters, and pull exactly one bag of **Jade Citrus Mint Green Tea** and one bag of **Peach Tranquility Herbal Tea**. Both plastic envelopes must be manually torn open by hand and the strings untangled before dropping them into the cup.
2.  **Honey Blend Pumping:** The recipe calls for 2 pumps (Tall), 1 pump (Grande), or 2 heavy pumps (Venti) of proprietary **Honey Blend Syrup** (or in older stores, manually tearing open sticky packets of raw clover honey and squeezing them into the bottom of the cup).
3.  **Hot Water Dilution:** The cup is filled exactly halfway with 200°F filtered hot water from the brewer tap to initiate tea steeping.
...
The Medicine Ball completely destroys this rhythmic sequencing cycle:
*   **Steam Wand Contamination:** The Mastrena steam wands are engineered and calibrated to steam dairy milk and plant-based milks. When a barista steams high-acid, high-sugar lemonade on the metal wand, the sugar proteins bake onto the hot stainless steel tip instantly. Before that wand can be used again for a regular latte, the barista must perform an aggressive, multi-second sanitation wipe and purge to prevent lemon flavor from transferring into the next customer's cappuccino.
*   **Station Cross-Travel:** Because dry tea boxes are typically stored on wall shelves behind the brewer, and lemonade is stored in under-counter cold wells, assembling a single Medicine Ball forces the Hot Bar barista to take 6 to 8 physical steps away from their espresso machine, leaving shots sitting dead in the shot glasses while they hunt for tea sachets.
